...
import { Router } from '@angular/router';import { User } from '../models/user';
...
export class LoginComponent implements OnInit {
  ...
  validateAndLoginUser() {
    ...
    // Call the loginUser method if both fields are filled
    this.loginUser();
  }
  validateAndLoginDoctor() {
    ...
    // Call the loginDoctor method if both fields are filled
    this.loginDoctor();
  }
  ...
  validateAndLoginAdmin() {
    ...
    // Call the adminLogin method if both fields are filled
    this.adminLogin();
  }
